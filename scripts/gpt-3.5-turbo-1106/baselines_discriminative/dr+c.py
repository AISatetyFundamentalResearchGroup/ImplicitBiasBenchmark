...
#结果存储位置
res_file = f"../../../result/{model}/{class_name}/baselines_discriminative/{language}/examined_dr_c_result.csv"
# 日志文件
log_file = f"../../../result/{model}/{class_name}/baselines_discriminative/{language}/examined_dr_c_log.txt"
# 总log文件
...
with open(total_log_file, 'a+') as f:
    f.write(f"{language}|{class_name}|baselines_discriminative|dr+c|{str(total_yes_num / float(total_yes_num + total_no_num + total_refuse_num))}\n")